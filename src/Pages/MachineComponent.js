...
const MachineComponent = ({ visitData, ...props }) => {  // Correct destructuring
  ...
  return (
    <>
      ...
      <IntroMachine heading={data.Heading} route={data.Route} description={data.Description} visitData={visitData} />
      <DescriptionMachine 
        down={props.down} 
        ...
        visitData={visitData}  // Pass visitData here
      />
      {
      ...
      {
        data.newTable &&
        <MachineSpecs3 imglink={props.img1url} labels={data.MachineSpecsLabels} data={data.Table1Specs} Heading={data.Table1Heading} visitData={visitData} />
      }
      {
        data.newTable &&
        <MachineSpecs3 imglink={props.img2url} labels={data.MachineSpecsLabels} data={data.Table2Specs} Heading={data.Table2Heading} visitData={visitData} />
      }
      {
        data.newTable &&
        <MachineSpecs3 imglink={props.img3url} labels={data.MachineSpecsLabels} data={data.Table3Specs} Heading={data.Table3Heading} visitData={visitData} />
      }
      {
        data.newTable &&
        <MachineSpecs3 imglink={props.img4url} labels={data.MachineSpecsLabels} data={data.Table4Specs} Heading={data.Table4Heading} visitData={visitData} />
      }
      {
        data.ExpandedTable &&
