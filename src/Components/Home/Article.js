                    ...
                    <div className="articlecards">
                        <div className="articlecard">
                            ...
                            <div className="lowersection">
                                ...
                                <Link to={'/blog/disposable-packaging-solutions-for-horeca/'} className='articlelink' ><img src={'https://nesscoindia.com/Assets/images/resource/readmoree.png'} alt='Disposable Packaging Solutions for HORECA'/></Link>
                            </div>
                        </div>
                        <div className="articlecard">
                            ...
                            <div className="lowersection">
                                ...
                                <Link className='articlelink' to={'/blog/why-say-yes-to-paper-cups/'}> <img src={'https://nesscoindia.com/Assets/images/resource/readmoree.png'} alt='Paper Cups – Responsible Consumer Choice?'/></Link>
                            </div>
                        </div>
                        <div className="articlecard condition2">
                            ...
                            <div className="lowersection">
                                ...
                                <Link className='articlelink' to={'/blog/paper-plate-making-machine-an-eco-friendly-alternative/'}><img src={'https://nesscoindia.com/Assets/images/resource/readmoree.png'} alt='Paper Plate Making Machine An Eco Friendly Alternative'/></Link>
                            </div>
                        </div>
                    </div>
                </div>
