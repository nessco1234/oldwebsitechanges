        ...
        <>
            ...
            <section className="blogdescsection">
                <div className="blogdescsectioncontainer">
                    ...
                    <h2 className="blogheading">Recycling of Paper:</h2>
                    ...
                    <h2 className="blogheading">Paper Forming Technology:</h2>
                    ...
                    <div className="blognavigationbtns marrr">
                        <h3 className="blognavigationdesc">Paper Cups - Responsible Consumers Choice?</h3>
