      ...
      <div className="aboutvision">
        <div className="aboutvisioncontainer">
          <div className="aboutvisionleft">
            <img src={'https://www.nesscoindia.com/Assets/images/gallery/about2.webp'} alt="About2" className="aboutvisionimg" />
          ...
          <div className="aboutvisionright">
            <h6 className="aboutusbtn">OUR VISION</h6>
            <h2 className="aboutvisionheading">Begins with <span>Innovation</span></h2>
            ...
            <img src={'https://www.nesscoindia.com/Assets/images/gallery/event3.webp'} alt="Event3" className="aboutvisionimg" />
          </div>
        </div>
      </div>
    </>
