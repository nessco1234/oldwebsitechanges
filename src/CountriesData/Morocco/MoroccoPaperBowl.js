...
const MoroccoPaperBowl = (visitData) => {
    return (
        <>
            <Helmet>
                <title>Paper Bowl Making Machine in Morocco | Nessco</title>
                ...
                <link rel="canonical" href="https://www.nesscoindia.com/ma/paper-container-bowl-making-machine/" />

            </Helmet>
            <section className="intromachine">
                <div className="intromachinecompo">
                    <div className="intromachineleft">
                        <h1 className="intromachineheading">Paper Bowl Making <br /><span>Machine In Morocco</span></h1>
            ...
            <section className="descriptionmachine">
                <div className="descriptionmachinecomp">
                    ...
                    <img src={'https://www.nesscoindia.com/Assets/images/resource/paper-container-bowl-machine.webp'} alt="" />
                        <h3 className="descriptionmachineleftdata">Paper Bowl Manufacturing <span>Machine In Morocco</span></h3>
...
export default MoroccoPaperBowl
