...
const MoroccoCartonErecting = (visitData) => {
    return (
        <>
            <Helmet>
                <title>Carton Erecting Machine | Paper Box Making Machine in Morocco | Nessco</title>
                ...
                <link rel="canonical" href="https://www.nesscoindia.com/ma/carton-erecting-machine/" />

            </Helmet>
            <section className="intromachine">
                <div className="intromachinecompo">
                    <div className="intromachineleft">
                        <h1 className="intromachineheading">Carton Erecting <br /><span>Machine In Morocco</span></h1>
            ...
            <section className="descriptionmachine">
                <div className="descriptionmachinecomp">
                    ...
                    <img src={'https://www.nesscoindia.com/Assets/images/resource/CartonErectingMachine.webp'} alt="" />
                        <h3 className="descriptionmachineleftdata"> Carton Erecting <span>Machine In Morocco</span></h3>
...
export default MoroccoCartonErecting
