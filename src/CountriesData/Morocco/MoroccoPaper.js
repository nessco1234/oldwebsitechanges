...
const MoroccoPaper = (visitData) => {
    const a = "Morocco";
    return (
        <>
            <Helmet>
                <title>Paper Cup Making Machine in {a} | Nessco</title>
                <meta name="description" content="Nessco offers a complete range of paper cup making machine in Morocco with latest technology for 40 years. High speed, Low power consumption. Get quote now!" />
                ...
                <link rel="canonical" href="https://www.nesscoindia.com/ma/paper-cup-making-machine/" />
            ...
            <section className="descriptionmachine">
                <div className="descriptionmachinecomp">
                    ...
                    <img src={'https://nesscoindia.com/Assets/images/resource/fully-automatic-paper-cup-machine.webp'} alt="" />
                        <h3 className="descriptionmachineleftdata">Paper Cup Manufacturing <span>Machine In {a}</span></h3>
                        <p className="descriptionmachineleftcontent">Nessco India brings you a top-quality range of <a href='https://www.nesscoindia.com/product/high-speed-paper-cup-making-machine/'> high speed paper cup making machine</a> in Morocco. which are multi-station automatic, capable of producing an unbelievable number of sustainable and eco-friendly paper cups at one time. Continuous automatic procedures such as sealing, oil filling, heating, knurling, curling, and unloading make it the ideal machine for paper cups.
                            <br /><br />
                            <b>
                            High Speed Paper Cup Forming Machine in Morocco
                            </b>
                            <br /><br></br>
