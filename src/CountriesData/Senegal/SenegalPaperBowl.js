...
const SenegalPaperBowl = (visitData) => {
    const a = "Senegal";
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://www.nesscoindia.com/sn/paper-container-bowl-making-machine/" />
...
export default SenegalPaperBowl
