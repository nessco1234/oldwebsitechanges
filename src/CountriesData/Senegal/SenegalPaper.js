...
const SenegalPaper = (visitData) => {
    const a = "Senegal";
    return (
        <>
            <Helmet>
                <title>Paper Cup Making Machine in {a} | Nessco</title>
                <meta name="description" content="Nessco offers a complete range of paper cup making machine in Senegal with latest technology for 40 years. High speed, Low power consumption. Get quote now!" />
                ...
                <link rel="canonical" href="https://www.nesscoindia.com/sn/paper-cup-making-machine/" />

            </Helmet>
            <section className="intromachine">
                <div className="intromachinecompo">
                    <div className="intromachineleft">
                        <h1 className="intromachineheading">Paper Cup Making <br /><span>Machine In {a}</span></h1>
                        <p className="intromachinedescription">
                            Nessco India is known for manufacturing and globally exporting various paper cup making machine in Senegal. With a strong functional position in this market for over 40 years, now we are backed by 5 Domestic Distributing Centers and 4 International Ones. Over all these years, we have spread our arms to almost every country to expand our business globally.
                        </p>
                    </div>
            ...
            <section className="descriptionmachine">
                <div className="descriptionmachinecomp">
                    ...
                    <img src={'https://nesscoindia.com/Assets/images/resource/fully-automatic-paper-cup-machine.webp'} alt="" />
                        <h3 className="descriptionmachineleftdata">Paper Cup Manufacturing <span>Machine In Senegal</span></h3>
                        <p className="descriptionmachineleftcontent">Nessco India brings you a top-quality range of <a href='https://www.nesscoindia.com/product/high-speed-paper-cup-making-machine/'> high speed paper cup making machine</a> in Senegal. which are multi-station automatic, capable of producing an unbelievable number of sustainable and eco-friendly paper cups at one time. Continuous automatic procedures such as sealing, oil filling, heating, knurling, curling, and unloading make it the ideal machine for paper cups.
                            <br /><br />
                            <b>
                            High Speed Paper Cup Forming Machine in Senegal
                            </b>
